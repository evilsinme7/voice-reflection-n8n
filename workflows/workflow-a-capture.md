...
Prompt（define 模式，v1.1 强化中英混杂与专名纠错）：
```
请处理以下文本，它来自语音转写，可能存在以下问题：缺少标点、有同音字错误、中英文混杂时英文单词或专有名词被错误识别（例如把英文词转成了发音相近的中文，或把中文专名拆错）。
